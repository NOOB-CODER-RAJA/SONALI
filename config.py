...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/NOOB-CODER-RAJA/SONALI",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/kedi_update")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Sprzn_arora_appeal")
